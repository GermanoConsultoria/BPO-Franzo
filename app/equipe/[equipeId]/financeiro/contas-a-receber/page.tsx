...
export default async function ContasAReceberPage({ params }: { params: Promise<{ equipeId: string }> }) {
  ...
  return (
    <div className="p-4 lg:p-8 max-w-7xl mx-auto">
      <header className="mb-6 border-b border-border pb-4">
        ...
        <p className="text-sm text-gray-500 mt-1">Gerencie as receitas e valores a receber deste cliente.</p>
      </header>
      <LancamentosView
        equipeId={equipeId}
